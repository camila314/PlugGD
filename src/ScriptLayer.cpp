...
bool ScriptLayer::init() {
	if (Cacao::CacAlertLayer::init(CCSizeMake(300, 200))) {
		...
		m_rightBtn = CCMenuItemSpriteExtra::create(rightSprite, this, menu_selector(ScriptLayer::onRight));
		...
		m_leftBtn = CCMenuItemSpriteExtra::create(leftSprite, this, menu_selector(ScriptLayer::onLeft));
		...
		auto mitem = CCMenuItemSpriteExtra::create(openSprite, this, menu_selector(ScriptLayer::onOpen));
		...
		#else
		m_pButtonMenu->addChild(m_rightBtn);
		m_pButtonMenu->addChild(m_leftBtn);
		m_pButtonMenu->addChild(mitem);
		#endif
